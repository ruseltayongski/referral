...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    document.documentElement.style.setProperty('--base-url', window.location.origin);
  },
  methods: {
    getBookedSlotsForDate: function getBookedSlotsForDate(date) {
      ...
      this.appointmentSlot.forEach(function (appointment) {
        ...
        appointment.appointment_schedules.forEach(function (slot) {
          // Check date AND booking
          if (slot.appointed_date === targetDate && slot.telemed_assigned_doctor && slot.telemed_assigned_doctor.length > 0) {
    ...
    // },  
    buildEventsFromSlots: function buildEventsFromSlots(dateselected, titleOpd, deptKey) {
      var _this2 = this;
      ...
      this.appointmentSlot.forEach(function (appointment) {
        appointment.appointment_schedules.filter(function (slot) {
          return slot.facility_id === _this2.facilitySelectedId;
        }).forEach(function (slot) {
          var _slot$telemed_assigne;
          var assignedCount = ((_slot$telemed_assigne = slot.telemed_assigned_doctor) === null || _slot$telemed_assigne === void 0 ? void 0 : _slot$telemed_assigne.length) || 0;
          var isFull = assignedCount >= slot.slot;
      ...
      var groupedByDeptAndDate = {};
      slotsForDate.forEach(function (slot) {
        var _slot$sub_opd, _slot$telemed_assigne2;
        var deptName = ((_slot$sub_opd = slot.sub_opd) === null || _slot$sub_opd === void 0 ? void 0 : _slot$sub_opd.description) || 'Unknown';
        var dateKey = slot.appointed_date; // group by exact date
        var key = "".concat(deptName, "_").concat(dateKey);
        var Available = slot.isAvailable;
      ...
      this.events = Object.entries(groupedByDeptAndDate).map(function (_ref) {
        var _ref2 = _slicedToArray(_ref, 2),
          key = _ref2[0],
          group = _ref2[1];
        var slotsArray = group.slots; // this is the array we want
        _this2.slotInfo = group;
        ...
        var start = moment(group.date, 'YYYY-MM-DD', true);
        if (!start.isValid()) return null;
        return {
          title: group.deptName,
          start: start.format('YYYY-MM-DD'),
          className: ["sub-opd-label", !hasAvailable && "slot-full", isUserBooked && "with-pin", isSelected && "with-pin-left"].filter(Boolean)
        };
      }).filter(Boolean);
    },
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _this3.calendar = $("#calendar").fullCalendar({
                ...
                editable: false,
                eventClick: function () {
                  var _eventClick = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(info) {
                    var event, clickedDate, deptKey, filterredSlots;
    ...
    scrollToHighlightedDate: function scrollToHighlightedDate() {
      this.$nextTick(function () {
        var availableCell = document.querySelector(".fc-day-grid-event.sub-opd-label");
        if (availableCell) {
    ...
    dayRenderFunction: function dayRenderFunction(date, cell) {
      var targetDate = date.format("YYYY-MM-DD");
      var bookedSlots = this.getBookedSlotsForDate(date);
      var info = null;
      if (Array.isArray(this.slotInfo)) {
        // slotInfo is an array → use find
        info = this.slotInfo.find(function (slot) {
          return slot === targetDate;
        });
      } else if (this.slotInfo && _typeof(this.slotInfo) === "object") {
      ...
      if (bookedSlots.length > 0) {
        // Build tooltip text
        var tooltipText = bookedSlots.map(function (slot) {
          // const assignment = slot.telemed_assigned_doctor[0]; // the booking record
          return "Booked Slot\nTime: ".concat(slot.appointed_time, "\n");
        }).join("\n\n");
    ...
    eventRenderFunction: function eventRenderFunction(event, element) {
      ...
      this.$nextTick(function () {
        ...
        element.css({
          'background-color': '',
          // default, green comes from CSS
          'border-color': ''
        });

        // Optional: tooltip showing booked slots
        if (((_slotData$telemed_ass = slotData.telemed_assigned_doctor) === null || _slotData$telemed_ass === void 0 ? void 0 : _slotData$telemed_ass.length) > 0) {
          var tooltipText = "Booked: ".concat(slotData.telemed_assigned_doctor.length, "/").concat(slotData.slot || 'N/A');
        ...
        _this4.appointmentSlot.forEach(function (appointment) {
          if (appointment.appointment_schedules && appointment.appointment_schedules.length > 0) {
            ...
            if (slotsOnDate.length > 0) allSlotsForDate.push.apply(allSlotsForDate, _toConsumableArray(slotsOnDate));
          }
        });
        if (allSlotsForDate.length > 0) {
          var facilitySlots = allSlotsForDate.filter(function (slot) {
            return slot.facility_id == _this4.facilitySelectedId;
          });
          var slotStatus = facilitySlots.map(function (slot) {
            var _slot$telemed_assigne3;
            var assignedCount = ((_slot$telemed_assigne3 = slot.telemed_assigned_doctor) === null || _slot$telemed_assigne3 === void 0 ? void 0 : _slot$telemed_assigne3.length) || 0;
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              uniqueDeptCount = new Set(deptObjects.filter(function (d) {
                return d.date === clickedDate;
              }).map(function (d) {
                return d.deptName;
              })).size;
              deptNameSet = new Set(deptObjects.filter(function (d) {
                return d.date === clickedDate;
              }).map(function (d) {
                return d.deptName;
              }));
              deptName = _toConsumableArray(deptNameSet)[0];
    ...
    updateCalendarEvents: function updateCalendarEvents() {
      ...
      this.events.forEach(function (event) {
        _this6.calendar.fullCalendar("renderEvent", event, true);
      });
    },
          ...
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 2:
              ...
              appointedParam = {
                ...
                borderColor: "#00a65a",
                facility_id: _this7.facilitySelectedId
              };
              _this7.appointedParams = appointedParam;
              return _context5.abrupt("return", appointedParam);
            case 13:
              ...
              return _context5.abrupt("return", mapedData);
            case 15:
            case "end":
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    appointedTimes: function appointedTimes(payload) {
    ...
    facilitySelectedId: function () {
      var _facilitySelectedId = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(newValue, oldValue) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
  ...
  computed: {
    sortedTimeSlots: function sortedTimeSlots() {
      return _toConsumableArray(this.timeSlots).sort(function (a, b) {
        var timeA = a.appointedTime.split(':').map(Number);
        var timeB = b.appointedTime.split(':').map(Number);
  ...
  methods: {
    ...
    isSlotPast: function isSlotPast(slot) {
      var now = new Date();
      var slotDateTime = new Date("".concat(slot.appointment_date, "T").concat(slot.appointedTime));
      var today = now.getFullYear() + '-' + String(now.getMonth() + 1).padStart(2, '0') + '-' + String(now.getDate()).padStart(2, '0');
      return slot.appointment_date === today && slotDateTime <= now;
    },
    formatTimeRange: function formatTimeRange(timeFrom, timeTo) {
    ...
    getSelectedSlot: function getSelectedSlot() {
      var _this = this;
      return this.timeSlots.find(function (slot) {
        return slot.id === _this.selectedAppointmentTime;
      });
    },
    handleProceedAppointment: function handleProceedAppointment() {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, null, 8 /* PROPS */, ["facilitySelectedId", "appointmentSlot", "user", "onAppointedTime", "onConfig_appointedTime", "onDayClickDate", "onManualClickDate"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_appointment_time, {
...
var _hoisted_11 = ["id", "value", "disabled", "onChange"];
var _hoisted_12 = ["for"];
var _hoisted_13 = {
  "class": "time-info"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [_cache[5] || (_cache[5] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", {
    "class": "page-header"
  }, "Time Slot", -1 /* HOISTED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [!$data.showAppointmentTime ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_7, _cache[2] || (_cache[2] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", {
    style: {
      "padding": "20px",
      "text-align": "center",
      "color": "#999"
    }
  }, " No available time slots. Please select a date. ", -1 /* HOISTED */)]))) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_8, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.sortedTimeSlots, function (slot) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      key: slot.id,
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["time-slot-item", {
        'selected': $data.selectedAppointmentTime === slot.id,
        'disabled': $options.isSlotPast(slot) || slot.slot <= 0
      }]),
      onClick: function onClick($event) {
        return !$options.isSlotPast(slot) && slot.slot > 0 ? $options.selectTimeSlot(slot) : null;
      }
      ...
      onChange: function onChange($event) {
        return $options.selectTimeSlot(slot);
      }
    }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_11), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelRadio, $data.selectedAppointmentTime]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
      "for": 'slot_' + slot.id,
      "class": "time-slot-label"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_13, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_14, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatTimeRange(slot.appointedTime, slot.appointedTimeTo)), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_15, [_cache[3] || (_cache[3] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
      "class": "fa fa-user-md"
    }, null, -1 /* HOISTED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_16, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.getDoctorName(slot)), 1 /* TEXT */)]), slot.slot ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_17, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(slot.slot) + " slot" + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(slot.slot > 1 ? "'s" : "") + " available ", 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 8 /* PROPS */, _hoisted_12)])], 10 /* CLASS, PROPS */, _hoisted_9);
  }), 128 /* KEYED_FRAGMENT */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Proceed Button "), $data.selectedAppointmentTime ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_18, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    onClick: _cache[1] || (_cache[1] = function () {
      return $options.handleProceedAppointment && $options.handleProceedAppointment.apply($options, arguments);
    }),
    "class": "btn btn-success btn-block btn-proceed"
  }, _cache[4] || (_cache[4] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "fa fa-check-circle"
  }, null, -1 /* HOISTED */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Proceed Appointment ")]))])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]))])])])])])]);
}
