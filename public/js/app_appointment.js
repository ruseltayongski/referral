  ...
  methods: {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              response = _context3.sent;
              _this3.configAppoinmentTime = response.data;
              _this3.$emit("getconfig-Appointment", response.data);
            case 5:
            case "end":
              return _context3.stop();
          }
    ...
    configAppointmentNot: function configAppointmentNot(timeSlot) {
      ...
      return this.configAppoinmentTime.some(function (config) {
        var normalizedConfigStartTime = _this4.normalizeTimeFormat(config.start_time);
        var normalizedConfigEndTime = _this4.normalizeTimeFormat(config.end_time);
