<template>
  <div class="modal fade" role="dialog" :id="modalId" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" :disabled="!privacyChecked" @click="accept">I Accept</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    show() {
      ...
      if (typeof $ !== 'undefined' && $(`#${this.modalId}`).length) {
