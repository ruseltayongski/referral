<template>
  <div class="modal fade" role="dialog" id="telemedicinePrivacyNoticeModal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" @click="closePrivacyNotice" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        ...
        <div class="modal-body" style="max-height: 800px; overflow-y: auto;">
          ...
          <div class="checkbox">
            <label>
              <input type="checkbox" id="privacyCheckbox" v-model="privacyChecked">
              <b>I have read and accept the Privacy Statement</b>
            </label>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" @click="closePrivacyNotice">Close</button>
          <button type="button" class="btn btn-primary" :disabled="!privacyChecked" @click="acceptPrivacyNotice">I Accept</button>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="modal-content">
        <div class="modal-body" style="padding: 0;">
          ...
          <form @submit.prevent="submitForm" style="padding: 20px;">
            ...
            <div class="row" style="margin-bottom: 15px;">
              <div class="col-md-12">
                <label style="font-size: 11px; font-weight: bold; margin-bottom: 5px;">FILE ATTACHMENTS</label>
