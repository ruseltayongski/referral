                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="collapse" id="collapse_reason_referral_pregnant" style="width: 100%;">
                                    ...
                                    <div class="container-referral">
                                        <select name="reason_referral1" class="form-control-select select2 reason_referral2" require>
...
<script>
    ...
    $('.reason_referral2').on('change', function() {
            var value = $(this).val();
                ...
                Lobibox.confirm({
                    ...
                    callback: function(lobibox, type){
                        if(type === 'no'){
                            ...
                            $('.reason_referral2').val('').trigger('change');
                        }else{
