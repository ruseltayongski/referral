    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content" id="version-content">
            ...
            <button  data-target="#normalFormModal" data-backdrop="static" data-toggle="modal" type="button" class="btn btn-warning col-sm-6">
                ...
                <button data-target="#revisednormalFormModal" data-backdrop="static" data-toggle="modal" type="button" class="btn btn-info col-sm-6">
                <img src="{{ url('resources/img/forms_ver2_icon.png') }}" width="100" />
                    <br />
                    Version 2
                </button>
...
<div class="modal fade" role="dialog" id="pregnantChooseVersionModal_walkin" style="text-align: center">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content" id="version-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
            <button  data-target="#pregnantFormModalWalkIn"  data-backdrop="static" data-toggle="modal" type="button" class="btn btn-warning col-sm-6">
                    <img src="{{ url('resources/img/forms_icon.png') }}" width="100" />
                    <br />
                    Version 1
                </button>
...
<div class="modal fade" role="dialog" id="nonPregnantChooseVersionModal_walkin" style="text-align: center">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content" id="version-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
