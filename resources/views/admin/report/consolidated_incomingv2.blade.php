            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="active tab-pane" id="outgoing{{ $row->id }}">
                        <?php
                            $outgoing = \DB::connection('mysql')->select("call consolidatedOutgoing('$facility_id')")[0];
                            $accepted_outgoing = \App\Activity::where("referred_from","=",$row->id)->where("status","=","accepted")->count();
                            $seenzoned_outgoing = \DB::connection('mysql')->select("call getViewedOnlyOutgoing('$facility_id')")[0]->seen_outgoing;
...
@section('js')
    ...
    <script>
        //Date range picker
        $('#reservation').daterangepicker({singleDatePicker: false,
