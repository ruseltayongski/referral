...
<h4>Grand Total</h4>
    ...
    <tbody id="collapse_astra_grand" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
        ...
        <tr style="background-color: #b1ffdb">
            ...
            <td rowspan="2">{{ $total_e_pop_sputnikv_a1_prov }}</td><!-- A1 SPUTNIKV_FIRST -->
            <td rowspan="2">{{ $total_e_pop_sputnikv_a2_prov }}</td><!-- A2 SPUTNIKV_FIRST -->
            <td rowspan="2">{{ $total_e_pop_sputnikv_a3_prov }}</td><!-- A3 SPUTNIKV_FIRST -->
            <td rowspan="2">{{ $total_e_pop_sputnikv_a4_prov }}</td><!-- A4 SPUTNIKV_FIRST -->
            <td rowspan="2">{{ $total_e_pop_sputnikv_prov }} <!-- TOTAL ELI POP SPUTNIKV_FIRST -->
            </td>
            <td rowspan="2">{{ $total_vallocated_sputnikv_frst_prov }} </td> <!-- VACCINE ALLOCATED (FD) SPUTNIKV_FIRST -->
            <td rowspan="2">{{ $total_vallocated_sputnikv_scnd_prov }} </td>  <!-- VACCINE ALLOCATED (SD) SPUTNIKV_FIRST -->
            <td rowspan="2"> {{ $total_vallocated_frst_sputnikv }}</td>  <!-- TOTAL VACCINE ALLOCATED SPUTNIKV_FIRST -->
            <td>
                <span class="label label-success">{{ $total_sputnikv_a1_frst_prov }}</span>   <!-- VACCINATED (A1) SPUTNIKV_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ $total_sputnikv_a2_frst_prov }}</span>  <!-- VACCINATED (A2) SPUTNIKV_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ $total_sputnikv_a3_frst_prov }}</span>  <!-- VACCINATED (A3) SPUTNIKV_FIRST -->
            </td>
            <td>
            ...
            <td>
                <span class="label label-success">{{ $total_srs_sputnikv_frst_prov }}</span> <!-- SERIOUS SPUTNIKV_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ $total_dfrd_sputnikv_frst_prov }}</span> <!-- DEFERRED SPUTNIKV_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ $total_rfsd_sputnikv_frst_prov }}</span> <!-- REFUSED SPUTNIKV_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ $total_wstge_sputnikv_frst_prov }}</span> <!-- WASTAGE SPUTNIKV_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ number_format($total_p_cvrge_sputnikv_frst_prov,2) }}%</span> <!-- PERCENT_COVERAGE SPUTNIKV_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ number_format($total_c_rate_sputnikv_frst_prov,2) }}%</span> <!-- CONSUMPTION RATE SPUTNIKV_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ $total_r_unvcted_frst_sputnikv_prov }}</span> <!-- REMAINUNG UNVACCINATED SPUTNIKV_FIRST -->
            </td>
        </tr>
        <tr style="background-color: #b1ffdb">
            <td style="color: black;">
                <span class="label label-warning">{{ $total_sputnikv_a1_scnd_prov }}</span>  <!-- VACCINATED (A1) SPUTNIKV_SECOND -->
            </td>
            <td style="color:black;">
                <span class="label label-warning">{{ $total_sputnikv_a2_scnd_prov }}</span>  <!-- VACCINATED (A2) SPUTNIKV_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_sputnikv_a3_scnd_prov }}</span>  <!-- VACCINATED (A3) SPUTNIKV_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_sputnikv_a4_scnd_prov }}</span>  <!-- VACCINATED (A4) SPUTNIKV_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_vcted_sputnikv_second }}</span>  <!-- TOTAL VACCINATED SPUTNIKV_SECOND -->
            </td> <!-- 1-6 -->
            <td>
                <span class="label label-warning">{{ $total_mild_sputnikv_scnd_prov }}</span>  <!-- MILD SPUTNIKV_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_srs_sputnikv_scnd_prov }}</span> <!-- SERIOUS SPUTNIKV_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_dfrd_sputnikv_scnd_prov }}</span> <!-- DEFERRED SPUTNIKV_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_rfsd_sputnikv_scnd_prov }}</span> <!-- REFUSED SPUTNIKV_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_wstge_sputnikv_scnd_prov }}</span> <!-- WASTAGE SPUTNIKV_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ number_format($total_p_cvage_sputnikv_scnd_prov,2) }}%</span> <!-- PERCENT_COVERAGE_SPUTNIKV_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ number_format($total_c_rate_sputnikv_scnd_prov,2) }}%</span> <!-- CONSUMPTION RATE SPUTNIKV_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_r_unvcted_scnd_sputnikv_prov }}</span> <!-- REMAINING UNVACCINATED SPUTNIKV_SECOND -->
            </td>
        </tr>
        </tbody>
        ...
        <tr style="background-color: #8fe7fd">
            ...
            <td rowspan="2">{{ $total_e_pop_pfizer_a1_prov }}</td><!-- A1 PFIZER_FIRST -->
            <td rowspan="2">{{ $total_e_pop_pfizer_a2_prov }}</td><!-- A2 PFIZER_FIRST -->
            <td rowspan="2">{{ $total_e_pop_pfizer_a3_prov }}</td><!-- A3 PFIZER_FIRST -->
            <td rowspan="2">{{ $total_e_pop_pfizer_a4_prov }}</td><!-- A4 PFIZER_FIRST -->
            <td rowspan="2">{{ $total_e_pop_pfizer_prov }} <!-- TOTAL ELI POP PFIZER_FIRST -->
            </td>
            <td rowspan="2">{{ $total_vallocated_pfizer_frst_prov }} </td> <!-- VACCINE ALLOCATED (FD) PFIZER_FIRST -->
            <td rowspan="2">{{ $total_vallocated_pfizer_scnd_prov }} </td>  <!-- VACCINE ALLOCATED (SD) PFIZER_FIRST -->
            <td rowspan="2"> {{ $total_vallocated_pfizer }}</td>  <!-- TOTAL VACCINE ALLOCATED PFIZER_FIRST -->
            <td>
                <span class="label label-success">{{ $total_pfizer_a1_frst_prov }}</span>   <!-- VACCINATED (A1) PFIZER_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ $total_pfizer_a2_frst_prov }}</span>  <!-- VACCINATED (A2) PFIZER_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ $total_pfizer_a3_frst_prov }}</span>  <!-- VACCINATED (A3) PFIZER_FIRST -->
            </td>
            <td>
            ...
            <td>
                <span class="label label-success">{{ $total_srs_pfizer_frst_prov }}</span> <!-- SERIOUS PFIZER_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ $total_dfrd_pfizer_frst_prov }}</span> <!-- DEFERRED PFIZER_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ $total_rfsd_pfizer_frst_prov }}</span> <!-- REFUSED PFIZER_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ $total_wstge_pfizer_frst_prov }}</span> <!-- WASTAGE PFIZER_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ number_format($total_p_cvrge_pfizer_frst_prov,2) }}%</span> <!-- PERCENT_COVERAGE PFIZER_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ number_format($total_c_rate_pfizer_frst_prov,2) }}%</span> <!-- CONSUMPTION RATE PFIZER_FIRST -->
            </td>
            <td>
                <span class="label label-success">{{ $total_r_unvcted_frst_pfizer_prov }}</span> <!-- REMAINUNG UNVACCINATED PFIZER_FIRST -->
            </td>
        </tr>
        <tr style="background-color: #8fe7fd">
            <td>
                <span class="label label-warning">{{ $total_pfizer_a1_scnd_prov }}</span>   <!-- VACCINATED (A1) PFIZER_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_pfizer_a2_scnd_prov }}</span> <!-- VACCINATED (A2) PFIZER_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_pfizer_a3_scnd_prov }}</span> <!-- VACCINATED (A3) PFIZER_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_pfizer_a4_scnd_prov }}</span> <!-- VACCINATED (A4) PFIZER_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_vcted_pfizer_second }}</span> <!-- TOTAL VACCINATED PFIZER_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_mild_pfizer_scnd_prov }}</span> <!-- MILD PFIZER_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_srs_pfizer_scnd_prov }}</span> <!-- SERIOUS  PFIZER_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_dfrd_pfizer_scnd_prov }}</span> <!-- DEFERRED  PFIZER_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_rfsd_pfizer_scnd_prov }}</span> <!-- REFUSED  PFIZER_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_wstge_pfizer_scnd_prov }}</span> <!-- WASTAGE PFIZER_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ number_format($total_p_cvage_pfizer_scnd_prov,2)}}%</span> <!-- PERCENT COVERAGE  PFIZER_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ number_format($total_c_rate_pfizer_scnd_prov,2) }}%</span> <!-- CONSUMPTION RATE PFIZER_SECOND -->
            </td>
            <td>
                <span class="label label-warning">{{ $total_r_unvcted_scnd_pfizer_prov }} </span> <!-- REMAINING UNVACCINATED  PFIZER_SECOND -->
            </td>
        </tr>
        </tbody>
