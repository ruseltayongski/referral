<tr style="background-color: #59ab91">
    ...
    <td style="width: 15%">
        <input type="text" id="date_picker{{ $count }}" name="daily_accomplishment" value="<?php if(isset($vaccine->dateof_del)) echo date('m/d/Y',strtotime($vaccine->dateof_del)) ?>" class="form-control" required>
    </td>
