        ...
        <div class="row" style="padding-left: 1%;padding-right: 1%">
            ...
            <div class="col-md-3">
                <div class="info-box" style="background-color: #ffe7d3" >
                    <span class="info-box-icon" style="background-color: #ffe7d3" ><i class="ion ion-ios-medkit-outline"></i></span>
                    <div class="info-box-content">
            ...
            <div class="col-md-3">
                <div class="info-box" style="background-color: #fffddb">
                    <span class="info-box-icon" style="background-color: #fffddb"><i class="ion ion-ios-medkit-outline"></i></span>
                    <div class="info-box-content">
                        ...
                        <div class="table-responsive">
                            <table style="width: 100%;">
                                ...
                                @foreach($data as $row)
                                    ...
                                    $total_vcted_svac_frst =  $total_svac_a1_frst + $total_svac_a2_frst + $total_svac_a3_frst + $total_svac_a4_frst ; //TOTAL VACCINATED_SINOVAC FIRST
                                    $total_vcted_astra_frst =  $total_astra_a1_frst + $total_astra_a2_frst + $total_astra_a3_frst + $total_astra_a4_frst ; //TOTAL VACCINATED_ASTRA FIRST
                                    $total_vcted_sputnikv_frst = $total_sputnikv_a1_frst + $total_sputnikv_a2_frst + $total_sputnikv_a3_frst + $total_sputnikv_a4_frst ; //TOTAL VACCINATED_SPUTNIKV FIRST
                                    $total_vcted_pfizer_frst =  $total_pfizer_a1_frst + $total_pfizer_a2_frst + $total_pfizer_a3_frst + $total_pfizer_a4_frst ; // TOTAL VACCINATED_PFIZER FIRST

                                    $total_vcted_svac_scnd =  $total_svac_a1_scnd + $total_svac_a2_scnd + $total_svac_a3_scnd + $total_svac_a4_scnd ; //TOTAL VACCINATED_SINOVAC SECOND
                                    $total_vcted_astra_scnd =  $total_astra_a1_scnd + $total_astra_a2_scnd + $total_astra_a3_scnd + $total_astra_a4_scnd ; //TOTAL VACCINATED_ASTRA SECOND
                                    $total_vcted_sputnikv_scnd = $total_sputnikv_a1_scnd + $total_sputnikv_a2_scnd + $total_sputnikv_a3_scnd + $total_sputnikv_a4_scnd ; //TOTAL VACCINATED_SPUTNIKV SECOND
                                    $total_vcted_pfizer_scnd =  $total_pfizer_a1_scnd + $total_pfizer_a2_scnd + $total_pfizer_a3_scnd + $total_pfizer_a4_scnd ; // TOTAL VACCINATED_PFIZER SECOND
