...
@section('js')
    <script>
                    ...
                    checkSlotExistence(effectiveDateValue,allCollectedSlots, timeSlotsDiv, days,category) 
                            ...
                            return `
                                ...
                                ">
                                    <div style="
                                        ...
                                        margin-bottom: 6px;
                                    ">
                                        <i class="fa fa-calendar" style="color:#007bff; margin-right:4px;"></i> ${readableDate}
                                    </div>
                                    <div style="
                                        display: flex;
                                        flex-wrap: wrap;
                        ...
                        $("#SchedCategory").html(`
                            <div class="col-md-12 schedule-output text-center" 
                                style="padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #fdfdfd; margin-top: 15px; max-width: 100%; overflow: visible;">
        ...
        function addTimeInput(ok) {
            ...
            $('input[name="slot' +adjustedCounts+ '"]').on('input', function() {
                if (this.value < 1) {
                    this.value = 1;
                }
            });
