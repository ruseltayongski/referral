...
@if($cur_status != 'accepted')
    ...
    @if(($referral_status == 'referred' || $referral_status == 'redirected') && $form->telemedicine == 0 || ($cur_status == 'redirected' || $cur_status == 'transferred')  && $form->telemedicine == 1 && $referral_status != 'referring')
    ...
    @elseif(($cur_status == 'followup' || $referral_status == 'referred') && $form->telemedicine == 1)
           
        <button class="btn-sm btn-danger btn-flat button_option" data-toggle="modal" data-target="#rejectModal"   data-latest-id-act="{{ $latestIdAct }}"><i class="fa fa-line-chart"></i> Declined</button>
        <button class="btn-sm btn-success btn-flat button_option" data-telemedicine="{{ $form->telemedicine }}" data-toggle="modal" data-target="#acceptFormModal"><i class="fa fa-check"></i> Accept</button>
    @endif
@endif
