                ...
                @foreach($data as $row)
                    ...
                    <div style="border:2px solid #7e7e7e;" class="panel panel-{{ $type }}">
                        ...
                        <div class="panel-footer">
                            ...
                            @endif  -->
                            @if((Session::get('referred_accepted_track') || Session::get('redirected_accepted_track') ) && !Session::get('referred_travel_track') && !$redirected_travel_track && !$referred_arrived_track && !$redirected_arrived_track && $row->referred_from == $user->facility_id)
                                <a href="#transferModal" data-toggle="modal"
                                   data-id="{{ $row->id }}" class="btn btn-xs btn-success btn-transfer"><i class="fa fa-ambulance"></i> Depart</a>
                            @endif
