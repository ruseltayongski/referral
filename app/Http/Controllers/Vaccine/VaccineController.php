...
class VaccineController extends Controller
{
    ...
    public function dataCollapseFacility(Request $request)
    {
        ...
        if($request->typeof_vaccine == "sinovac")
        {
            ...
            $total_a1_frst = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_first :0; //A1_SINOVAC
            $total_a2_frst = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_first :0; //A2_SINOVAC
            $total_a3_frst = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_first :0; //A3_SINOVAC
            $total_a4_frst = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_first :0; //A4_SINOVAC
            $total_a5_frst = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_first :0; //A5_SINOVAC
            $total_b1_frst = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_first :0; //B1_SINOVAC
            $total_b2_frst = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b2")->whereNull("facility_id")->first()->vaccinated_first :0; //B2_SINOVAC
            $total_b3_frst = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b3")->whereNull("facility_id")->first()->vaccinated_first :0; //B3_SINOVAC
            $total_b4_frst = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b4")->whereNull("facility_id")->first()->vaccinated_first :0; //B4_SINOVAC

            $total_a1_scnd = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_second :0; //A1_SINOVAC 2
            $total_a2_scnd = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_second :0; //A2_SINOVAC 2
            $total_a3_scnd = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_second :0; //A3_SINOVAC 2
            $total_a4_scnd = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_second :0; //A4_SINOVAC 2
            $total_a5_scnd = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_second :0; //A5_SINOVAC 2
            $total_b1_scnd = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_second :0; //B1_SINOVAC 2
            $total_b2_scnd = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b2")->whereNull("facility_id")->first()->vaccinated_second :0; //B2_SINOVAC 2
            $total_b3_scnd = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b3")->whereNull("facility_id")->first()->vaccinated_second :0; //B3_SINOVAC 2
            $total_b4_scnd = $request->typeof_vaccine == "sinovac" || empty($request->typeof_vaccine_filter) ? \App\Facility::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b4")->whereNull("facility_id")->first()->vaccinated_second :0; //B4_SINOVAC 2
