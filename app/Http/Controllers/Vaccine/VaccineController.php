...
class VaccineController extends Controller
{
    ...
    public function dataCollapse(Request $request)
    {
       ...
       $total_epop_svac_a1 = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? $global_elipop_a1 :0; //E_POP_A1_SINOVAC
       $total_epop_svac_a2 = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? $global_elipop_a2 :0; //E_POP_A2_SINOVAC
       $total_epop_svac_a3 = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? $global_elipop_a3 :0; //E_POP_A3_SINOVAC
       $total_epop_svac_a4 = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? $global_elipop_a4 :0; //E_POP_A4_SINOVAC
       $total_epop_svac_a5 = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? $global_elipop_a5 :0; //E_POP_A5_SINOVAC
       $total_epop_svac_b1 = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? $global_elipop_b1 :0; //E_POP_B1_SINOVAC
       $total_epop_svac_b2 = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? $global_elipop_b2 :0; //E_POP_B2_SINOVAC
       $total_epop_svac_b3 = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? $global_elipop_b3 :0; //E_POP_B3_SINOVAC
       $total_epop_svac_b4 = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? $global_elipop_b4 :0; //E_POP_B4_SINOVAC
       ...
       //ASTRAZENECA
       $total_epop_astra_a1 = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? $global_elipop_a1 :0; //E_POP_A1_ASTRA
       $total_epop_astra_a2 = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? $global_elipop_a2 :0; //E_POP_A2_ASTRA
       $total_epop_astra_a3 = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? $global_elipop_a3 :0; //E_POP_A3_ASTRA
       $total_epop_astra_a4 = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? $global_elipop_a4 :0; //E_POP_A4_ASTRA
       $total_epop_astra_a5 = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? $global_elipop_a5 :0; //E_POP_A5_ASTRA
       $total_epop_astra_b1 = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? $global_elipop_b1 :0; //E_POP_B1_ASTRA
       $total_epop_astra_b2 = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? $global_elipop_b2 :0; //E_POP_B2_ASTRA
       $total_epop_astra_b3 = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? $global_elipop_b3 :0; //E_POP_B3_ASTRA
       $total_epop_astra_b4 = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? $global_elipop_b4 :0; //E_POP_B4_ASTRA
       ...
       $total_epop_overall = $request->a1 + $request->a2 + $request->a3 + $request->a4 + $request->a5 + $request->b1 + $request->b2 + $request->b3 + $request->b4;

       //PFIZER
       $total_epop_pfizer_a1 = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? $global_elipop_a1 : 0; //E_POP_A1_PFIZER
       $total_epop_pfizer_a1 = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? $global_elipop_a1 : 0; //E_POP_A1_PFIZER
       $total_epop_pfizer_a2 = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? $global_elipop_a2 : 0; //E_POP_A2_PFIZER
       $total_epop_pfizer_a3 = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? $global_elipop_a3 : 0; //E_POP_A3_PFIZER
       $total_epop_pfizer_a4 = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? $global_elipop_a4 : 0; //E_POP_A4_PFIZER
       $total_epop_pfizer_a5 = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? $global_elipop_a5 : 0; //E_POP_A5_PFIZER
       $total_epop_pfizer_b1 = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? $global_elipop_b1 : 0; //E_POP_B1_PFIZER
       $total_epop_pfizer_b2 = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? $global_elipop_b2 : 0; //E_POP_B2_PFIZER
       $total_epop_pfizer_b3 = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? $global_elipop_b3 : 0; //E_POP_B3_PFIZER
       $total_epop_pfizer_b4 = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? $global_elipop_b4 : 0; //E_POP_B4_PFIZER
       ...
       //SPUTNIK V
       $total_epop_sputnikv_a1 = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? $global_elipop_a1 : 0; //E_POP_A1_SPUTNIKV
       $total_epop_sputnikv_a2 = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? $global_elipop_a2 : 0; //E_POP_A2_SPUTNIKV
       $total_epop_sputnikv_a3 = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? $global_elipop_a3 : 0; //E_POP_A3_SPUTNIKV
       $total_epop_sputnikv_a4 = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? $global_elipop_a4 : 0; //E_POP_A4_SPUTNIKV
       $total_epop_sputnikv_a5 = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? $global_elipop_a5 : 0; //E_POP_A5_SPUTNIKV
       $total_epop_sputnikv_b1 = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? $global_elipop_b1 : 0; //E_POP_B1_SPUTNIKV
       $total_epop_sputnikv_b2 = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? $global_elipop_b2 : 0; //E_POP_B2_SPUTNIKV
       $total_epop_sputnikv_b3 = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? $global_elipop_b3 : 0; //E_POP_B3_SPUTNIKV
       $total_epop_sputnikv_b4 = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? $global_elipop_b4 : 0; //E_POP_B4_SPUTNIKV
       ...
       //MODERNA
       $total_epop_moderna_a1 = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? $global_elipop_a1 : 0; //E_POP_A1_MODERNA
       $total_epop_moderna_a2 = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? $global_elipop_a2 : 0; //E_POP_A2_MODERNA
       $total_epop_moderna_a3 = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? $global_elipop_a3 : 0; //E_POP_A3_MODERNA
       $total_epop_moderna_a4 = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? $global_elipop_a4 : 0; //E_POP_A4_MODERNA
       $total_epop_moderna_a5 = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? $global_elipop_a5 : 0; //E_POP_A5_MODERNA
       $total_epop_moderna_b1 = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? $global_elipop_b1 : 0; //E_POP_B1_MODERNA
       $total_epop_moderna_b2 = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? $global_elipop_b2 : 0; //E_POP_B2_MODERNA
       $total_epop_moderna_b3 = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? $global_elipop_b3 : 0; //E_POP_B3_MODERNA
       $total_epop_moderna_b4 = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? $global_elipop_b4 : 0; //E_POP_B4_MODERNA
       ...
       //JOHNSON
       $total_epop_johnson_a1 = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? $global_elipop_a1 : 0; //E_POP_A1_JOHNSON
       $total_epop_johnson_a2 = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? $global_elipop_a2 : 0; //E_POP_A2_JOHNSON
       $total_epop_johnson_a3 = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? $global_elipop_a3 : 0; //E_POP_A3_JOHNSON
       $total_epop_johnson_a4 = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? $global_elipop_a4 : 0; //E_POP_A4_JOHNSON
       $total_epop_johnson_a5 = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? $global_elipop_a5 : 0; //E_POP_A5_JOHNSON
       $total_epop_johnson_b1 = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? $global_elipop_b1 : 0; //E_POP_B1_JOHNSON
       $total_epop_johnson_b2 = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? $global_elipop_b2 : 0; //E_POP_B2_JOHNSON
       $total_epop_johnson_b3 = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? $global_elipop_b3 : 0; //E_POP_B3_JOHNSON
       $total_epop_johnson_b4 = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? $global_elipop_b4 : 0; //E_POP_B4_JOHNSON
       ...
       //VACCINE_ALLOCATED
       $total_vallocated_svac_frst = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? $request->sinovac_allocated_first :0; //VACCINE ALLOCATED_SINOVAC (FD)
       $total_vallocated_svac_scnd = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ?  $request->sinovac_allocated_second :0; //VACCINE ALLOCATED_SINOVAC (SD)
       $total_vallocated_astra_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ?  $request->astrazeneca_allocated_first :0; //VACCINE ALLOCATED_ASTRA (FD)
       $total_vallocated_astra_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ?  $request->astrazeneca_allocated_second :0; //VACCINE ALLOCATED_ASTRA (SD)
       $total_vallocated_pfizer_frst = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ?  $request->pfizer_allocated_first :0; //VACCINE ALLOCATED_PFIZER (FD)
       $total_vallocated_pfizer_scnd = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ?  $request->pfizer_allocated_second :0; //VACCINE ALLOCATED_PFIZER (SD)
       $total_vallocated_sputnikv_frst = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ?  $request->sputnikv_allocated_first :0; //VACCINE ALLOCATED_SPUTNIKV (FD)
       $total_vallocated_sputnikv_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ?  $request->sputnikv_allocated_second :0; //VACCINE ALLOCATED_SPUTNIKV (SD)
       $total_vallocated_moderna_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ?  $request->moderna_allocated_first :0; //VACCINE ALLOCATED_MODERNA (FD)
       $total_vallocated_moderna_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ?  $request->moderna_allocated_second :0; //VACCINE ALLOCATED_MODERNA (SD)
       $total_vallocated_johnson_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ?  $request->johnson_allocated_first :0; //VACCINE ALLOCATED_MODERNA (FD)
       $total_vallocated_johnson_scnd = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ?  $request->johnson_allocated_second :0; //VACCINE ALLOCATED_MODERNA (SD)


       //VACCINATED_SINOVAC_FIRST
       $total_svac_a1_frst = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_first :0; //A1_SINOVAC
       $total_svac_a2_frst = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_first :0; //A2_SINOVAC
       $total_svac_a3_frst = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_first :0; //A3_SINOVAC
       $total_svac_a4_frst = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_first :0; //A4_SINOVAC
       $total_svac_a5_frst = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_first :0; //A5_SINOVAC
       $total_svac_b1_frst = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_first :0; //B1_SINOVAC
       $total_svac_b2_frst = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b2")->whereNull("facility_id")->first()->vaccinated_first :0; //B2_SINOVAC
       $total_svac_b3_frst = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b3")->whereNull("facility_id")->first()->vaccinated_first :0; //B3_SINOVAC
       $total_svac_b4_frst = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b4")->whereNull("facility_id")->first()->vaccinated_first :0; //B4_SINOVAC

       //VACCINATED_SINOVAC_SECOND
       $total_svac_a1_scnd = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_second :0; //A1_SINOVAC 2
       $total_svac_a2_scnd = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_second :0; //A2_SINOVAC 2
       $total_svac_a3_scnd = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_second :0; //A3_SINOVAC 2
       $total_svac_a4_scnd = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_second :0; //A4_SINOVAC 2
       $total_svac_a5_scnd = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_second :0; //A5_SINOVAC 2
       $total_svac_b1_scnd = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_second :0; //B1_SINOVAC 2
       $total_svac_b2_scnd = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b2")->whereNull("facility_id")->first()->vaccinated_second :0; //B2_SINOVAC 2
       $total_svac_b3_scnd = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b3")->whereNull("facility_id")->first()->vaccinated_second :0; //B3_SINOVAC 2
       $total_svac_b4_scnd = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->where("priority","b4")->whereNull("facility_id")->first()->vaccinated_second :0; //B4_SINOVAC 2

       //VACCINATED_ASTRAZENECA_FIRST
       $total_astra_a1_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_first :0; //A1_ASTRA
       $total_astra_a2_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_first :0; //A2_ASTRA
       $total_astra_a3_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_first :0; //A3_ASTRA
       $total_astra_a4_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_first :0; //A4_ASTRA
       $total_astra_a5_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_first :0; //A5_ASTRA
       $total_astra_b1_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_first :0; //B1_ASTRA
       $total_astra_b2_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","b2")->whereNull("facility_id")->first()->vaccinated_first :0; //B2_ASTRA
       $total_astra_b3_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","b3")->whereNull("facility_id")->first()->vaccinated_first :0; //B3_ASTRA
       $total_astra_b4_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","b4")->whereNull("facility_id")->first()->vaccinated_first :0; //B4_ASTRA

       //VACCINATED_ASTRAZENECA_SECOND
       $total_astra_a1_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_second :0; //A1_ASTRA 2
       $total_astra_a2_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_second :0; //A2_ASTRA 2
       $total_astra_a3_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_second :0; //A3_ASTRA 2
       $total_astra_a4_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_second :0; //A4_ASTRA 2
       $total_astra_a5_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_second :0; //A5_ASTRA 2
       $total_astra_b1_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_second :0; //B1_ASTRA 2
       $total_astra_b2_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","b2")->whereNull("facility_id")->first()->vaccinated_second :0; //B2_ASTRA 2
       $total_astra_b3_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","b3")->whereNull("facility_id")->first()->vaccinated_second :0; //B3_ASTRA 2
       $total_astra_b4_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->where("priority","b4")->whereNull("facility_id")->first()->vaccinated_second :0; //B4_ASTRA 2

       //VACCINATED_PFIZER_FIRST
       $total_pfizer_a1_frst = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_first :0; //A1_PFIZER
       $total_pfizer_a2_frst = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_first :0; //A2_PFIZER
       $total_pfizer_a3_frst = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_first :0; //A3_PFIZER
       $total_pfizer_a4_frst = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_first :0; //A4_PFIZER
       $total_pfizer_a5_frst = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_first :0; //A5_PFIZER
       $total_pfizer_b1_frst = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_first :0; //B1_PFIZER
       $total_pfizer_b2_frst = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","b2")->whereNull("facility_id")->first()->vaccinated_first :0; //B2_PFIZER
       $total_pfizer_b3_frst = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","b3")->whereNull("facility_id")->first()->vaccinated_first :0; //B3_PFIZER
       $total_pfizer_b4_frst = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","b4")->whereNull("facility_id")->first()->vaccinated_first :0; //B4_PFIZER

       //VACCINATED_PFIZER_SECOND
       $total_pfizer_a1_scnd = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_second :0; //A1_PFIZER 2
       $total_pfizer_a2_scnd = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_second :0; //A2_PFIZER 2
       $total_pfizer_a3_scnd = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_second :0; //A3_PFIZER 2
       $total_pfizer_a4_scnd = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_second :0; //A4_PFIZER 2
       ...
       //VACCINATED_SPUTNIKV_FIRST
       $total_sputnikv_a1_frst = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_first :0; //A1_SPUTNIKV
       $total_sputnikv_a2_frst = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_first :0; //A2_SPUTNIKV
       $total_sputnikv_a3_frst = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_first :0; //A3_SPUTNIKV
       $total_sputnikv_a4_frst = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_first :0; //A4_SPUTNIKV
       $total_sputnikv_a5_frst = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_first :0; //A5_SPUTNIKV
       $total_sputnikv_b1_frst = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_first :0; //B1_SPUTNIKV
       ...
       $total_sputnikv_b4_frst = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","b4")->whereNull("facility_id")->first()->vaccinated_first :0; //B4_SPUTNIKV

       //VACCINATED_SPUTNIKV_SECOND
       $total_sputnikv_a1_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_second :0; //A1_SPUTNIKV 2
       $total_sputnikv_a2_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_second :0; //A2_SPUTNIKV 2
       $total_sputnikv_a3_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_second :0; //A3_SPUTNIKV 2
       $total_sputnikv_a4_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_second :0; //A4_SPUTNIKV 2
       $total_sputnikv_a5_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_second :0; //A5_SPUTNIKV 2
       $total_sputnikv_b1_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_second :0; //B1_SPUTNIKV 2
       $total_sputnikv_b2_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","b2")->whereNull("facility_id")->first()->vaccinated_second :0; //B2_SPUTNIKV 2
       $total_sputnikv_b3_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->where("priority","b3")->whereNull("facility_id")->first()->vaccinated_second :0; //B3_SPUTNIKV 2
       ...
       //VACCINATED_MODERNA_FIRST
       $total_moderna_a1_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_first :0; //A1_MODERNA
       $total_moderna_a2_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_first :0; //A2_MODERNA
       $total_moderna_a3_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_first :0; //A3_MODERNA
       $total_moderna_a4_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_first :0; //A4_MODERNA
       $total_moderna_a5_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_first :0; //A5_MODERNA
       $total_moderna_b1_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_first :0; //B1_MODERNA
       $total_moderna_b2_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","b2")->whereNull("facility_id")->first()->vaccinated_first :0; //B2_MODERNA
       $total_moderna_b3_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","b3")->whereNull("facility_id")->first()->vaccinated_first :0; //B3_MODERNA
       $total_moderna_b4_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","b4")->whereNull("facility_id")->first()->vaccinated_first :0; //B4_MODERNA

       //VACCINATED_MODERNA_SECOND
       $total_moderna_a1_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_second :0; //A1_MODERNA 2
       $total_moderna_a2_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_second :0; //A2_MODERNA 2
       $total_moderna_a3_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_second :0; //A3_MODERNA 2
       $total_moderna_a4_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_second :0; //A4_MODERNA 2
       $total_moderna_a5_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_second :0; //A5_MODERNA 2
       $total_moderna_b1_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_second :0; //B1_MODERNA 2
       $total_moderna_b2_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","b2")->whereNull("facility_id")->first()->vaccinated_second :0; //B2_MODERNA 2
       $total_moderna_b3_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","b3")->whereNull("facility_id")->first()->vaccinated_second :0; //B3_MODERNA 2
       $total_moderna_b4_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->where("priority","b4")->whereNull("facility_id")->first()->vaccinated_second :0; //B4_MODERNA 2

       //VACCINATED_JOHNSON_FIRST
       $total_johnson_a1_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_first :0; //A1_JOHNSON
       $total_johnson_a2_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_first :0; //A2_JOHNSON
       $total_johnson_a3_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_first :0; //A3_JOHNSON
       $total_johnson_a4_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_first :0; //A4_JOHNSON
       $total_johnson_a5_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_first :0; //A5_JOHNSON
       $total_johnson_b1_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_first :0; //B1_JOHNSON
       $total_johnson_b2_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","b2")->whereNull("facility_id")->first()->vaccinated_first :0; //B2_JOHNSON
       $total_johnson_b3_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","b3")->whereNull("facility_id")->first()->vaccinated_first :0; //B3_JOHNSON
       $total_johnson_b4_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_first,0)) as vaccinated_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","b4")->whereNull("facility_id")->first()->vaccinated_first :0; //B4_JOHNSON

       //VACCINATED_JOHNSON_SECOND
       $total_johnson_a1_scnd = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","a1")->whereNull("facility_id")->first()->vaccinated_second :0; //A1_JOHNSON 2
       $total_johnson_a2_scnd = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","a2")->whereNull("facility_id")->first()->vaccinated_second :0; //A2_JOHNSON 2
       $total_johnson_a3_scnd = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","a3")->whereNull("facility_id")->first()->vaccinated_second :0; //A3_JOHNSON 2
       $total_johnson_a4_scnd = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","a4")->whereNull("facility_id")->first()->vaccinated_second :0; //A4_JOHNSON 2
       $total_johnson_a5_scnd = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","a5")->whereNull("facility_id")->first()->vaccinated_second :0; //A5_JOHNSON 2
       $total_johnson_b1_scnd = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","b1")->whereNull("facility_id")->first()->vaccinated_second :0; //B1_JOHNSON 2
       $total_johnson_b2_scnd = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","b2")->whereNull("facility_id")->first()->vaccinated_second :0; //B2_JOHNSON 2
       $total_johnson_b3_scnd = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","b3")->whereNull("facility_id")->first()->vaccinated_second :0; //B3_JOHNSON 2
       $total_johnson_b4_scnd = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(vaccinated_second,0)) as vaccinated_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->where("priority","b4")->whereNull("facility_id")->first()->vaccinated_second :0; //B4_JOHNSON 2

       $total_mild_svac_frst =  $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(mild_first,0)) as mild_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->whereNull("facility_id")->first()->mild_first :0; //MILD_SINOVAC
       $total_mild_astra_frst =  $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(mild_first,0)) as mild_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->whereNull("facility_id")->first()->mild_first :0; //MILD_ASTRA
       $total_mild_pfizer_frst =  $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(mild_first,0)) as mild_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->whereNull("facility_id")->first()->mild_first :0; //MILD_PFIZER
       $total_mild_sputnikv_frst =  $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(mild_first,0)) as mild_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->whereNull("facility_id")->first()->mild_first :0; //MILD_SPUTNIKV
       $total_mild_moderna_frst =  $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(mild_first,0)) as mild_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->whereNull("facility_id")->first()->mild_first :0; //MILD_MODERNA
       $total_mild_johnson_frst =  $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(mild_first,0)) as mild_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->whereNull("facility_id")->first()->mild_first :0; //MILD_JOHNSON

       $total_mild_svac_scnd =  $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(mild_second,0)) as mild_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->whereNull("facility_id")->first()->mild_second :0; //MILD_SINOVAC 2
       $total_mild_astra_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(mild_second,0)) as mild_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->whereNull("facility_id")->first()->mild_second :0; //MILD_ASTRA 2
       $total_mild_pfizer_scnd = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(mild_second,0)) as mild_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->whereNull("facility_id")->first()->mild_second :0; //MILD_PFIZER 2
       $total_mild_sputnikv_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(mild_second,0)) as mild_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->whereNull("facility_id")->first()->mild_second :0; //MILD_SPUTNIK 2
       $total_mild_moderna_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(mild_second,0)) as mild_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->whereNull("facility_id")->first()->mild_second :0; //MILD_MODERNA 2
       $total_mild_johnson_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(mild_second,0)) as mild_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->whereNull("facility_id")->first()->mild_second :0; //MILD_JOHNSON 2

       $total_srs_svac_frst =  $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ?  \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(serious_first,0)) as serious_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->whereNull("facility_id")->first()->serious_first :0; //SERIOUS_SINOVAC
       $total_srs_astra_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(serious_first,0)) as serious_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->whereNull("facility_id")->first()->serious_first :0; //SERIOUS_ASTRA
       ...
       $total_srs_sputnikv_frst = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(serious_first,0)) as serious_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->whereNull("facility_id")->first()->serious_first :0; //SERIOUS_SPUTNIKV
       $total_srs_moderna_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(serious_first,0)) as serious_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->whereNull("facility_id")->first()->serious_first :0; //SERIOUS_MODERNA
       $total_srs_johnson_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(serious_first,0)) as serious_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->whereNull("facility_id")->first()->serious_first :0; //SERIOUS_JOHNSON

       $total_srs_svac_scnd =  $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(serious_second,0)) as serious_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->whereNull("facility_id")->first()->serious_second :0; //SERIOUS_SINOVAC 2
       $total_srs_astra_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(serious_second,0)) as serious_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->whereNull("facility_id")->first()->serious_second :0;  //SERIOUS_AZTRAZENECA 2
       $total_srs_pfizer_scnd = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(serious_second,0)) as serious_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->whereNull("facility_id")->first()->serious_second :0; //SERIOUS_PFIZER2
       $total_srs_sputnikv_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(serious_second,0)) as serious_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->whereNull("facility_id")->first()->serious_second :0; // SERIOUS SPUTNIK2
       $total_srs_moderna_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(serious_second,0)) as serious_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->whereNull("facility_id")->first()->serious_second :0; // SERIOUS MODERNA2
       $total_srs_johnson_scnd = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(serious_second,0)) as serious_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->whereNull("facility_id")->first()->serious_second :0; // SERIOUS JOHNSON2

       $total_dfrd_svac_frst =  $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ?  \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(deferred_first,0)) as deferred_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->whereNull("facility_id")->first()->deferred_first :0; //DEFERRED_SINOVAC
       $total_dfrd_astra_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(deferred_first,0)) as deferred_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->whereNull("facility_id")->first()->deferred_first :0;  //DEFERRED_ASTRAZENECA
       $total_dfrd_pfizer_frst = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ?\App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(deferred_first,0)) as deferred_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->whereNull("facility_id")->first()->deferred_first :0; //DEFERRED_PFIZER
       $total_dfrd_sputnikv_frst = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(deferred_first,0)) as deferred_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->whereNull("facility_id")->first()->deferred_first :0;  //DEFERRED_SPUTNIKV
       $total_dfrd_moderna_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(deferred_first,0)) as deferred_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->whereNull("facility_id")->first()->deferred_first :0;  //DEFERRED_MODERNA
       $total_dfrd_johnson_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(deferred_first,0)) as deferred_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->whereNull("facility_id")->first()->deferred_first :0;  //DEFERRED_JOHNSON

       $total_dfrd_svac_scnd =  $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(deferred_second,0)) as deferred_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->whereNull("facility_id")->first()->deferred_second :0; //DEFERRED_SINOVAC 2
       $total_dfrd_astra_scnd =  $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(deferred_second,0)) as deferred_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->whereNull("facility_id")->first()->deferred_second :0; //DEFERRED_ASTRA 2
       $total_dfrd_pfizer_scnd =  $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(deferred_second,0)) as deferred_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->whereNull("facility_id")->first()->deferred_second :0; //DEFERRED_PFIZER 2
       $total_dfrd_sputnikv_scnd =  $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(deferred_second,0)) as deferred_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->whereNull("facility_id")->first()->deferred_second :0; //DEFERRED_SPUTNIKV 2
       $total_dfrd_moderna_scnd =  $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(deferred_second,0)) as deferred_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->whereNull("facility_id")->first()->deferred_second :0; //DEFERRED_MODERNA 2
       ...
       $total_rfsd_svac_frst =  $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(refused_first,0)) as refused_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->whereNull("facility_id")->first()->refused_first :0; //REFUSED_SINOVAC
       $total_rfsd_astra_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(refused_first,0)) as refused_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->whereNull("facility_id")->first()->refused_first :0; //REFUSED_ASTRA
       $total_rfsd_pfizer_frst = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(refused_first,0)) as refused_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->whereNull("facility_id")->first()->refused_first :0; //REFUSED_PFIZER
       $total_rfsd_sputnikv_frst = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(refused_first,0)) as refused_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->whereNull("facility_id")->first()->refused_first :0; //REFUSED_SPUTNIKV
       $total_rfsd_moderna_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(refused_first,0)) as refused_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->whereNull("facility_id")->first()->refused_first :0; //REFUSED_JOHNSON
       $total_rfsd_johnson_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(refused_first,0)) as refused_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->whereNull("facility_id")->first()->refused_first :0; //REFUSED_JOHNSON

       $total_rfsd_svac_scnd =  $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(refused_second,0)) as refused_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->whereNull("facility_id")->first()->refused_second :0; //REFUSED_SINOVAC 2
       $total_rfsd_astra_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(refused_second,0)) as refused_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->whereNull("facility_id")->first()->refused_second :0; //REFUSED_ASTRA 2
       $total_rfsd_pfizer_scnd = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(refused_second,0)) as refused_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->whereNull("facility_id")->first()->refused_second :0; //REFUSED_PFIZER 2
       $total_rfsd_sputnikv_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(refused_second,0)) as refused_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->whereNull("facility_id")->first()->refused_second :0; //REFUSED_SPUTNIKV 2
       $total_rfsd_moderna_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(refused_second,0)) as refused_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->whereNull("facility_id")->first()->refused_second :0; //REFUSED_MODERNA 2
       $total_rfsd_johnson_scnd = $request->typeof_vaccine_filter == "Johnsonj" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(refused_second,0)) as refused_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->whereNull("facility_id")->first()->refused_second :0; //REFUSED_JOHNSON 2

       $total_wstge_svac_frst = $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ?  \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(wastage_first,0)) as wastage_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->whereNull("facility_id")->first()->wastage_first :0; //WASTAGF_SINOVAC
       $total_wstge_astra_frst = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ?  \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(wastage_first,0)) as wastage_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->whereNull("facility_id")->first()->wastage_first :0; //WASTAGE_ASTRA
       ...
       $total_wstge_sputnikv_frst = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ?  \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(wastage_first,0)) as wastage_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->whereNull("facility_id")->first()->wastage_first :0; //WASTAGE_SPUTNIKV
       $total_wstge_moderna_frst = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ?  \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(wastage_first,0)) as wastage_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->whereNull("facility_id")->first()->wastage_first :0; //WASTAGE_MODERNA
       $total_wstge_johnson_frst = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ?  \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(wastage_first,0)) as wastage_first"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->whereNull("facility_id")->first()->wastage_first :0; //WASTAGE_JOHNSON


       $total_wstge_svac_scnd =  $request->typeof_vaccine_filter == "Sinovac" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(wastage_second,0)) as wastage_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Sinovac")->whereNull("facility_id")->first()->wastage_second :0; //WASTAGE_SINOVAC 2
       $total_wstge_astra_scnd = $request->typeof_vaccine_filter == "Astrazeneca" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(wastage_second,0)) as wastage_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Astrazeneca")->whereNull("facility_id")->first()->wastage_second :0; //WASTAGE_ASTRA2
       $total_wstge_pfizer_scnd = $request->typeof_vaccine_filter == "Pfizer" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(wastage_second,0)) as wastage_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Pfizer")->whereNull("facility_id")->first()->wastage_second :0; //WASTAGE_PFIZER2
       $total_wstge_sputnikv_scnd = $request->typeof_vaccine_filter == "SputnikV" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(wastage_second,0)) as wastage_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","SputnikV")->whereNull("facility_id")->first()->wastage_second :0; //WASTAGE_SPUTNIKV2
       $total_wstge_moderna_scnd = $request->typeof_vaccine_filter == "Moderna" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(wastage_second,0)) as wastage_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Moderna")->whereNull("facility_id")->first()->wastage_second :0; //WASTAGE_MODERNA 2
       $total_wstge_johnson_scnd = $request->typeof_vaccine_filter == "Johnson" || empty($request->typeof_vaccine_filter) ? \App\VaccineAccomplished::select(\DB::raw("SUM(COALESCE(wastage_second,0)) as wastage_second"))->where("province_id",$request->province_id)->where("muncity_id",$request->muncity_id)->where("typeof_vaccine","Johnson")->whereNull("facility_id")->first()->wastage_second :0; //WASTAGE_JOHNSON 2
       ...
       return view($view,[
             "muncity_id" => $request->muncity_id,
             "total_epop_svac_a1" => $total_epop_svac_a1,
             "total_epop_svac_a2" => $total_epop_svac_a2,
             "total_epop_svac_a3" => $total_epop_svac_a3,
             "total_epop_svac_a4" => $total_epop_svac_a4,
             "total_epop_svac_a5" => $total_epop_svac_a5,
             "total_epop_svac_b1" => $total_epop_svac_b1,
             "total_epop_svac_b2" => $total_epop_svac_b2,
             "total_epop_svac_b3" => $total_epop_svac_b3,
             "total_epop_svac_b4" => $total_epop_svac_b4,
             "total_epop_svac" => $total_epop_svac,
             "allocated_first" => $request->allocated_first,
             "allocated_second" => $request->allocated_second,
             "total_vallocated_svac" => $total_vallocated_svac,
             "total_svac_a1_frst" => $total_svac_a1_frst,
             "total_svac_a2_frst" => $total_svac_a2_frst,
             "total_svac_a3_frst" => $total_svac_a3_frst,
             "total_svac_a4_frst" => $total_svac_a4_frst,
             "total_svac_a5_frst" => $total_svac_a5_frst,
             "total_svac_b1_frst" => $total_svac_b1_frst,
             "total_svac_b2_frst" => $total_svac_b2_frst,
             "total_svac_b3_frst" => $total_svac_b3_frst,
             "total_svac_b4_frst" => $total_svac_b4_frst,
             "total_vcted_svac_frst" => $total_vcted_svac_frst,
             "total_mild_svac_frst" => $total_mild_svac_frst,
             "total_srs_svac_frst" => $total_srs_svac_frst,
             "total_dfrd_svac_frst" => $total_dfrd_svac_frst,
             "total_rfsd_svac_frst" => $total_rfsd_svac_frst,
             "total_wstge_svac_frst" => $total_wstge_svac_frst,
             "p_cvrge_svac_frst" => $p_cvrge_svac_frst,
             "total_c_rate_svac_frst" => $total_c_rate_svac_frst,
             "total_r_unvcted_frst_svac" => $total_r_unvcted_frst_svac,

             "total_svac_a1_scnd" => $total_svac_a1_scnd,
             "total_svac_a2_scnd" => $total_svac_a2_scnd,
             "total_svac_a3_scnd" => $total_svac_a3_scnd,
             "total_svac_a4_scnd" => $total_svac_a4_scnd,
             "total_svac_a5_scnd" => $total_svac_a5_scnd,
             "total_svac_b1_scnd" => $total_svac_b1_scnd,
             "total_svac_b2_scnd" => $total_svac_b2_scnd,
             "total_svac_b3_scnd" => $total_svac_b3_scnd,
             "total_svac_b4_scnd" => $total_svac_b4_scnd,
             "total_vcted_svac_scnd" => $total_vcted_svac_scnd,
             "total_mild_svac_scnd" => $total_mild_svac_scnd,
             "total_srs_svac_scnd" => $total_srs_svac_scnd,
             "total_dfrd_svac_scnd" => $total_dfrd_svac_scnd,
             "total_rfsd_svac_scnd" => $total_rfsd_svac_scnd,
             "total_wstge_svac_scnd" => $total_wstge_svac_scnd,
             "p_cvrge_svac_scnd" => $p_cvrge_svac_scnd,
             "total_c_rate_svac_scnd" => $total_c_rate_svac_scnd,
             "total_r_unvcted_scnd_svac" => $total_r_unvcted_scnd_svac,
